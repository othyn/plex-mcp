...
final class PlexServer extends Server
{
    ...
    protected string $instructions = 'Provides access to Plex Media Server. Use the available tools to monitor active playback sessions, search the library for movies, TV shows, and music, get content details, manage playlists, browse recently added content, view watch history, and check the on deck queue.';
